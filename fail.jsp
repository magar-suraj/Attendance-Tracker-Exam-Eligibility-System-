...
<head>
    <meta charset="UTF-8">
    <title>Eligibility Result - Warning</title>
    <style>
      body { 
...
<body>
    ...
    <div class="result-card">
        ...
        <p class="message">
            Sorry!<br>
            Your attendance is below the 75% requirement. You are <b>not eligible</b> for the exam. 😟
        </p>

        <a href="home.html" class="back-btn">Try Again</a>
    </div>
